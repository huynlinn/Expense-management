...
if (strlen($_SESSION['detsuid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into tblexpense(UserId,id_categories,ExpenseDate,ExpenseItem,ExpenseCost) value('$userid','$id_categories','$dateexpense','$item','$costitem')");
        if ($query) {
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form role="form" method="post" action="">
                                ...
                                <div class="form-group">
                                    <label>Categories of Cost</label><br>
                                    <div class="custom-select" style="width:200px;">
                                        <select name="id_categories">
                                            <option>Select Course</option>
                                            <?php foreach ($options as $option) { ?>
                                            <option name="name_categories"
                                                value="<?php echo $option['id_categories'] ?>" value="id_categories">
